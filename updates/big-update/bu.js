...
"tok-comment">/* ──────────────────── bigupdate_1_grass.js ──────────────────── */
"tok-comment">/* ═══════════════════════════════════════════════════════════════
...
"tok-comment">/* ──────────────────── bigupdate_2_fertilizer.js ──────────────────── */
"tok-comment">/* ═══════════════════════════════════════════════════════════════
...
"tok-comment">/* ──────────────────── bigupdate_3_jobs.js ──────────────────── */
"tok-comment">/* ═══════════════════════════════════════════════════════════════
...
(function () {
  ...
  css.textContent = [
    ...
    '}',
    "tok-comment">/* Till Field toolbar button */
    '#tool-tillall {',
    ...
    "tok-comment">/* Job status pill in the job card */
    '.job-income-note {',
  ...
  "tok-comment">/* ── State helpers ───────────────────────────────────────────── */
  "tok-keyword">function ensureJob() {
    "tok-keyword">if ("tok-keyword">typeof G !== 'undefined' && G.job === "tok-keyword">undefined) G.job = "tok-keyword">null;
  }

  "tok-comment">/* ── Patch initState ─────────────────────────────────────────── */
  "tok-keyword">var _wI = "tok-keyword">setInterval("tok-keyword">function () {
    "tok-keyword">if ("tok-keyword">typeof window.initState !== 'function') "tok-keyword">return;
    "tok-keyword">clearInterval(_wI);
    "tok-keyword">var _o = window.initState;
    window.initState = "tok-keyword">function () { _o.apply("tok-keyword">this, arguments); "tok-keyword">if (G) G.job = "tok-keyword">null; };
  }, 100);

  "tok-comment">/* ── Patch loadState ─────────────────────────────────────────── */
  "tok-keyword">var _wL = "tok-keyword">setInterval("tok-keyword">function () {
    "tok-keyword">if ("tok-keyword">typeof window.loadState !== 'function') "tok-keyword">return;
    "tok-keyword">clearInterval(_wL);
    "tok-keyword">var _o = window.loadState;
    window.loadState = "tok-keyword">function (s) {
      _o.apply("tok-keyword">this, arguments);
      "tok-keyword">if (G && G.job === "tok-keyword">undefined) G.job = "tok-keyword">null;
    };
  }, 100);

  "tok-comment">/* ── Hire / quit ─────────────────────────────────────────────── */
  window.hireJob = "tok-keyword">function (id) {
    "tok-keyword">var job = JOBS[id];
    "tok-keyword">if (!job) "tok-keyword">return;
    ensureJob();
    "tok-keyword">if (G.job === id) { "tok-keyword">if ("tok-keyword">typeof toast === 'function') toast('You already have this job!', 'warn'); "tok-keyword">return; }
    "tok-keyword">if (G.gold < job.hireCost) {
      "tok-keyword">if ("tok-keyword">typeof toast === 'function') toast('Need ' + job.hireCost + 'g to take this job!', 'error');
      "tok-keyword">if ("tok-keyword">typeof snd === 'function') snd('error');
      "tok-keyword">return;
    }
    "tok-keyword">if (G.job !== "tok-keyword">null) {
      "tok-comment">/* Auto-quit old job */
      "tok-keyword">var oldJob = JOBS[G.job];
      "tok-keyword">if ("tok-keyword">typeof toast === 'function' && oldJob)
...
"tok-comment">/* ──────────────────── bigupdate_4_hoe.js ──────────────────── */
"tok-comment">/* ═══════════════════════════════════════════════════════════════
...
(function () {
  ...
  "tok-comment">/* UPGRADES is declared with `const` in script.js but it is an
